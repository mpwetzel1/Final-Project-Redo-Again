...
#######  Download and import
temp <- file("/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/test.zip")

download.file("https://www.cdc.gov/brfss/annual_data/2015/files/LLCP2015XPT.zip", 
              "/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/test.zip")


unzip("/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/test.zip",exdir = 
        "/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo")
...
brfss2015b <- select(brfss2015, X_STATE, IMONTH,  IYEAR, SEX, LSATISFY,  QLACTLM2,  POORHLTH,  PHYSHLTH, GENHLTH, NUMADULT, CHILDREN,  
                     MEDCOST,  SMOKE100,  X_AGE80, X_HISPANC,  X_PRACE1,  EDUCA, EMPLOY1, INCOME2, CELLFON2,  DECIDE, X_PSU, X_LLCPWT,
                     X_STSTR, X_STRWT )
...
download.file("https://www.cdc.gov/brfss/annual_data/2014/files/LLCP2014XPT.zip", 
              "/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/BRFSS2014.zip")


unzip("/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/BRFSS2014.zip",exdir = 
        "/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo")
...
brfss2014b <- select(brfss2014, X_STATE, IMONTH,  IYEAR, LSATISFY,  QLACTLM2,  POORHLTH,  PHYSHLTH, GENHLTH, 
                     ...
                     CELLFON2,  DECIDE, X_PSU, X_LLCPWT, X_STSTR)
...
download.file("https://www.cdc.gov/brfss/annual_data/2013/files/LLCP2013XPT.zip", 
              "/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/BRFSS2013.zip")


unzip("/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/BRFSS2013.zip",exdir = 
        "/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo")
...
download.file("https://www.cdc.gov/brfss/annual_data/2012/files/LLCP2012XPT.zip", 
              "/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/BRFSS2012.zip")


unzip("/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/BRFSS2012.zip",exdir = 
        "/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo")
...
brfss2012b <- select(brfss2012, X_STATE, IMONTH,  IYEAR, LSATISFY,  QLACTLM2,  POORHLTH,  PHYSHLTH, GENHLTH, 
                     ...
                     CELLFON2, HIVRISK3, X_PSU, X_LLCPWT, X_STSTR)
...
download.file("https://www.cdc.gov/brfss/annual_data/2011/files/LLCP2011XPT.zip", 
              "/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/BRFSS2011.zip")


unzip("/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/BRFSS2011.zip",exdir = 
        "/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo")
...
download.file("http://www.cdc.gov/brfss/annual_data/2010/files/CDBRFS10XPT.zip", 
              "/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/BRFSS2010.zip")


unzip("/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo/BRFSS2010.zip",exdir = 
        "/Users/marthawetzel/Desktop/Emory/04_Spring 2018/NRSG 741/Final Project/Final-Project-Redo")
...
brfss2010b <- select(brfss2010, X_STATE, IMONTH,  IYEAR, LSATISFY,  QLACTLM2,  POORHLTH,  PHYSHLTH, GENHLTH, 
                     NUMADULT, CHILDREN,  MEDCOST,  SMOKE100,  SEX, AGE, HISPANC2,  X_PRACE,  EDUCA, EMPLOY, INCOME2,
                     CELLFON, HIVRISK2, X_PSU, X_STRWT, X_STSTR, _IMPNPH, POSTSTRAT)
...
allbrfss <- bind_rows(brfss2011b, brfss2012b, brfss2013b, brfss2014b, brfss2015b)
...
alldata <- alldata %>% mutate(DaysLimited = if_else(POORHLTH==88, 0,
                                                      if_else( POORHLTH <= 30, POORHLTH, NA_real_)))

alldata <- alldata %>% mutate(Limited_bin = if_else(DaysLimited > 14, 1, 0, NA_real_))
...
# PHYSHLTH
alldata <- alldata %>% mutate(PhysHealthBad = if_else(PHYSHLTH==88, 0,
                                                      if_else( PHYSHLTH <= 30, PHYSHLTH, NA_real_)))

alldata <- alldata %>% mutate(BadPhys_Bin = if_else(PhysHealthBad > 14, 1, 0, NA_real_))
...
levels_fc <- c(1, 2, 3, 4)
labels_fc <- c("One Adult No Children", "Multiple Adults No Children", "One Adult Plus Children", 
...
alldata$FamComp <- factor(alldata$FamComp, levels = c(1, 2, 3, 4), labels = 
                            c("One Adult No Children", "Multiple Adults No Children", "One Adult Plus Children", 
                                                                              "Multiple Adults Plus Children"))
...
# EDIT 3/27/18 - Clean out response values 7 and 9
names(alldata)[names(alldata) == 'Age'] <- 'AgeOld3'
alldata <- alldata %>% mutate(Age = if_else(AgeOld3 == 7 | AgeOld3 ==9, NA_real_, as.double(AgeOld3)))
...
alldata <- alldata %>% mutate(Race_cln = if_else(is.na(X_PRACE), X_PRACE1, 
                                                  if_else(X_PRACE == 3, 4, 
                                                  if_else(X_PRACE == 4, 5, 
                                                  if_else(X_PRACE == 5, 3, X_PRACE)))))

# FIX MISSING RACE
alldata <- alldata %>% mutate(Race_cln = if_else(Race_cln == 77 | Race_cln == 99, NA_real_,
                                                 if_else(Race_cln == 7 | Race_cln == 8, 6, Race_cln)))

table(alldata$Race_cln, exclude=NULL)
table(alldata$X_PRACE)
table(alldata$X_PRACE1)

alldata$Race_cln <- factor(alldata$Race_cln,
                                levels = c(1, 2, 3, 4, 5, 6), labels = c("White", "Black", "AIAN", "Asian",
...
alldata$CurrentPolicy <- factor(alldata$CurrentPolicy,
                                  levels = c(1,2,3), labels = c("None", "Optional", "Mandatory"))
...
# General Health
# First set factor labels
alldata$GenHealthFac <- factor(alldata$GENHLTH_cln,
                                 levels = c(1,2,3, 4, 5), labels = c("Excellent", "Very good", "Good", "Fair", "Poor"))

# Education
# First set factor labels
alldata$EDUCA_cln <- factor(alldata$EDUCA_cln,
                              levels = c(1,2,3, 4, 5, 6), labels = c("Never attended", "Grades 1 through 8", "Grades 9 through 11", "Grade 12 or GED", "Some College","College 4 years or more"))
...
test <- alldata %>% 
  srvyr::as_survey_design(ids=X_PSU, weight=X_LLCPWT, nest = T, strata=X_STSTR, variables= c(X_STATE, IMONTH,  IYEAR, SEX,
                                                                                             LSATISFY,  QLACTLM2,  POORHLTH,  PHYSHLTH, GENHLTH, NUMADULT, CHILDREN,  
                                                                                             MEDCOST,  SMOKE100,  X_AGE80, X_HISPANC,  X_PRACE1,  EDUCA, EMPLOY1, INCOME2, CELLFON2,  DECIDE))



save(alldata, file = "mydata.RData")
